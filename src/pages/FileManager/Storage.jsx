...
const Storage = ({ dataColors }) => {
  ...
  const total = userCount + fournisseurCount + connexionCount || 1;
  const percent = Math.round((total / 100) * 100); // ou une logique plus fine
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [usersRes, fournisseursRes, connexionsRes] = await Promise.all([
        ...
        <div className="text-center">
          ...
          {!loading ? (
            <p className="text-muted mt-4">
              {fournisseurCount} fournisseurs / {userCount} utilisateurs / {connexionCount} connexions
            </p>
          ) : (
          ...
          <Card className="border shadow-none mb-2">
            <div className="p-2 d-flex align-items-center">
              ...
              <div className="overflow-hidden me-auto">
                ...
                <Link to="/users">
                  <Button size="sm" color="primary">Voir plus</Button>
                </Link>
              </div>
            </div>
          </Card>
            ...
            <div className="p-2 d-flex align-items-center">
              ...
              <div className="overflow-hidden me-auto">
                ...
                <Link to="/fournisseurs">
                  <Button size="sm" color="warning">Voir plus</Button>
                </Link>
              </div>
            </div>
          </Card>
          ...
          <Card className="border shadow-none mb-2">
            <div className="p-2 d-flex align-items-center">
              ...
              <div className="overflow-hidden me-auto">
                ...
                <Link to="/historique">
                  <Button size="sm" color="success">Voir plus</Button>
                </Link>
              </div>
            </div>
          </Card>
